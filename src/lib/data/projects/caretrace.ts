...
export const caretrace: Project = {
  ...
  blocks: [
    ...
    },
    {
      ...
      keys: ["screens"],
      data: [
        { entity: "Visits", screens: 9 },
        { entity: "Caregivers", screens: 7 },
        { entity: "Patients", screens: 6 },
        { entity: "Care Plans", screens: 5 },
        { entity: "Agencies", screens: 4 },
        { entity: "Invoices", screens: 4 },
        { entity: "Care Notes", screens: 3 },
      ],
    },
    {
      _type: "imageGallery",
