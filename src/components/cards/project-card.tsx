...
export function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col justify-end bg-gradient-to-t from-black/80 via-black/20 to-transparent p-4 opacity-0 transition-opacity duration-300 max-sm:opacity-100 group-hover:opacity-100">
        <h3 className="text-[28px] font-semibold leading-tight text-white max-sm:text-[16px]">{project.name}</h3>
